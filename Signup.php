...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    } elseif (!preg_match('/^\+63\d{10}$/', $email)) {
        $errors[] = "Please enter a valid 11-digit mobile number with +63.";
    }
...
<body>
    ...
    <div class="content">
       ...
       minlength="13" 
       inputmode="numeric" 
       title="Please enter a valid 11-digit mobile number with +63"
       onkeypress="return /[0-9]/i.test(event.key)"
       oninput="addPrefix(this)"
       value="+63">
