...
/* Amount input field */
.amount-adjustment input[type="number"] {
    padding: 8px;
    font-size: 14px;
    width: 150px;
...
/* Deduct button inside amount adjustment */
...
.amount-adjustment button:hover {
...
<div class="main-content">
    ...
    <div class="loan-box">
        ...
        <div class="slider-container">
            ...
            <input type="range" id="loan-slider" min="1000" max="50000" step="500" value="1000">
        </div>
        <h2>Installment</h2>
...
<!-- PHP code to fetch users and their transactions -->
<?php
...
if ($user = $user_result->fetch_assoc()) {
    ...
    if ($balance > 0) {
        echo "<span id='user-balance-{$user['id']}'>" . number_format($balance, 2) . "</span>";
    } else {
    ...
    echo "</div>
        <div class='buttons'>
            <!-- Buttons (if needed for any action like Delete or Clear Balance) -->
        </div>
        <div class='amount-adjustment'>
            <!-- You can add a form here if needed for other actions (e.g., deduct balance, etc.) -->
        </div>
    </div>";
} else {
    echo "User not found.";
