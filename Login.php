...
<body>
    ...
    <div class="content">
        ...
        <div class="main-container">
            ...
            <img src="logo.png" class="logo-print" alt="Logo">
                <h1 id="firsth1">Building Trust, Funding Dreams.</h1>
            </div>
            ...
            <div class="login-content">
                <div class="login-container" aria-labelledby="login-heading">
                    ...
                    <!-- Login Form -->
                    <form class="login-form" method="POST" action="Loginlogic.php" aria-labelledby="login-heading" autocomplete="off">
    ...
    <div class="secondary-btns">
        ...
        <div class="flag-container">
            ...
            <a href="Logintagalog.php" class="flag-link" aria-label="Philippines">
